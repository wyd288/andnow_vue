<template>
  <div id="page-inner">
    ...
    <div class="row">
      ...
      <div class="col-md-3 col-sm-12 col-xs-12">
        <div class="panel back-dash">
          ...
          <strong>&nbsp; SPEED</strong>
          <p class="text-muted">
            Lorem ipsum dolor sit amet, consectetur adipiscing sit ametsit amet
            elit ftr. Lorem ipsum dolor sit amet, consectetur adipiscing elit.
          </p>
        </div>
      </div>
      <div class="col-md-3 col-sm-12 col-xs-12">
    ...
    <div class="row">
            ...
            <ul class="chat-box">
              <li class="left clearfix">
                <span class="chat-img pull-left">
                  <!-- <img src="../images/1.png" alt="User" class="img-circle" /> -->
                </span>
                <div class="chat-body">
              ...
              <li class="right clearfix">
                <span class="chat-img pull-right">
                  <!-- <img src="../images/2.png" alt="User" class="img-circle" /> -->
                </span>
              ...
              <li class="left clearfix">
                <span class="chat-img pull-left">
                  <!-- <img src="../images/3.png" alt="User" class="img-circle" /> -->
                </span>
                <div class="chat-body clearfix">
                  <strong>Jack Sparrow</strong>
                  <small class="pull-right text-muted">
              ...
              <li class="right clearfix">
                <span class="chat-img pull-right">
                  <!-- <img src="../images/4.png" alt="User" class="img-circle" /> -->
                </span>
                <div class="chat-body clearfix">
                  <small class="text-muted">
      ...
      <div class="col-md-6 col-sm-12 col-xs-12">
        <div class="panel panel-default">
          <div class="panel-heading">标签实例</div>
          <div class="panel-body">
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <div id="morris-donut-chart"></div>版权所有
